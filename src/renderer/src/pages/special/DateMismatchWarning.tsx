    ...
    <>
      <div className="h-screen bg-main-content">
        ...
        <div className="flex h-full justify-center items-center -translate-y-8 overflow-hidden px-6">
          <div className="flex flex-col items-center gap-6 max-w-sm w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex flex-col items-center gap-2 text-center">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Your device&apos;s date doesn&apos;t match the verified time for your timezone.
                Please correct your system clock to continue.
              </p>
            </div>
